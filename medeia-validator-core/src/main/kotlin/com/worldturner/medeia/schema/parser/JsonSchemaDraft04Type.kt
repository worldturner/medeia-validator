...
object JsonSchemaDraft04TypeCore : ObjectType(
    ...
    propertyTypes = listOf(
        ...
        PropertyType("if", JsonSchemaDraft04TypeReference, "ifSchema"),
        PropertyType("then", JsonSchemaDraft04TypeReference, "thenSchema"),
        PropertyType("else", JsonSchemaDraft04TypeReference, "elseSchema"),
